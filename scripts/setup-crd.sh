...
# renovate:github-url
kustomize build https://github.com/kubernetes-sigs/aws-load-balancer-controller//config/default?ref=v3.0.0 > crd.yaml
python3 openapi2jsonschema.py crd.yaml && rm crd.yaml
...
# renovate:github-url
python3 openapi2jsonschema.py https://github.com/kyverno/kyverno/releases/download/v1.16.2/install.yaml
