...
# renovate:github-url
kustomize build https://github.com/kubernetes-sigs/aws-load-balancer-controller//config/default?ref=v2.14.1 > crd.yaml
python3 openapi2jsonschema.py crd.yaml && rm crd.yaml
...
helm template --include-crds --repo https://victoriametrics.github.io/helm-charts/ --set settings.clusterName=test victoria-metrics-k8s-stack --version "0.63.0" > crd.yaml
python3 openapi2jsonschema.py crd.yaml && rm crd.yaml
