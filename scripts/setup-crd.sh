...
# renovate:github-url
python3 openapi2jsonschema.py https://github.com/kyverno/kyverno/releases/download/v1.17.1/install.yaml
...
helm template --include-crds --repo https://victoriametrics.github.io/helm-charts/ --set settings.clusterName=test victoria-metrics-k8s-stack --version "0.72.0" > crd.yaml
python3 openapi2jsonschema.py crd.yaml && rm crd.yaml
